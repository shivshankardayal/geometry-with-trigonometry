...
\pdfoutline goto name {geometry} count 1 {1. Geometry}%
\hldest {}{}{geometry}%
\xrdef{geometry1}
...
meaning `land measurement'. It consiste of two words `geo' which means earth and `meterin' which means to
...
\pdfoutline goto name {lines} count 2 {1.1 Points, Lines and Planes}%
\hldest {}{}{lines}%
\xrdef{lines1}
