...
\def\addtruepage{%
   \vbox to 0pt{\vskip -\headmargin\vskip -2pc
      \moveleft\cropmargin\hbox to \totalwidth{%
         \twelvebf
         \quad Geometry with Trigonometry\hss
...
\def\chaprule{\vrule depth1\baselineskip height1.5pc width0.5pt}
